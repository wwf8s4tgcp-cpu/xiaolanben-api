...
class NotificationHelper {
  ...
  static async insertNotification(pool, notificationData) {
    const result = await pool.query(
      'INSERT INTO notifications (user_id, sender_id, type, title, target_id, comment_id, is_read) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING id',
      [
  ...
  static async deleteNotifications(pool, conditions) {
    ...
    let query = 'DELETE FROM notifications WHERE type = $1 AND target_id = $2 AND sender_id = $3';
  ...
  static async getNotificationReceivers(pool, conditions) {
    ...
    const { rows } = await pool.query(
      'SELECT DISTINCT user_id FROM notifications WHERE type = $1 AND target_id = $2 AND sender_id = $3',
